...
- "TARGET": 
  ...
  • "OBJECT": Provide the object or classification (e.g., "PLANET", "ASTEROID") relevant to the action. If this information is not applicable, leave it as an empty string ''.
